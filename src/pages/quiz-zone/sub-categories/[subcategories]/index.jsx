...
const QuizZone = () => {
                ...
                unlockpremiumcateApi(
                  ...
                  res => {
                    ...
                    UserCoinScoreApi(
                      ...
                      null,
                      null,
                      'Quiz Zone Premium SubCategories',
                      '1',
                      response => {
                        getusercoinsApi(
                          responseData => {
  ...
  const filteredSubCategories = Array.isArray(subCategory) ? subCategory.filter(cat =>
    cat.subcategory_name.toLowerCase().includes(searchTerm.toLowerCase())
  ) : [];

  return (
    <Layout>

      <Breadcrumb showBreadcrumb={true} title={t("Quiz Zone")} content={t("Quiz-zone")} contentTwo={subCategory[0]?.main_category_name} />
                          ...
                          <div className="row">
                            <>
                              {filteredSubCategories.length > 0 ? (
                                filteredSubCategories.map((elem, key) => {
                                  return (
                                    <div
                                      key={elem.id}
